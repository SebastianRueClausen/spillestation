...
impl fmt::Display for Opcode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self.op() {
            ...
            0x20 => write!(f, "lb {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x21 => write!(f, "lh {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x22 => write!(f, "lwl {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x23 => write!(f, "lw {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x24 => write!(f, "lbu {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x25 => write!(f, "lhu {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x26 => write!(f, "lwr {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x28 => write!(f, "sb {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x29 => write!(f, "sh {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x2a => write!(f, "swl {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x2b => write!(f, "sw {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
            0x2e => write!(f, "swr {} {:08x}({})", self.rt(), self.signed_imm(), self.rs()),
